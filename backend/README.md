...
## Project Structure
    ...
    ├── testupgradesuperuser_3  # Django project configurations
...
1. Clone this repo and `cd testupgradesuperuser_3`
...
2. Clone this repo and `cd testupgradesuperuser_3`
